        ...
        <div class="container-fluid">
                ...
                <div id="dashboard">
                        ...
                        <div class="row">
                                ...
                                <div class="tiles" style="display:table-row;float:left;">
                                    <div class="tile bg-green" onclick="location.href='charts.php';">
                                        <div class="tile-body">
                                            <i class="" style="margin-top:30px;font-size: 40px;">20,50</i>
                                        </div>
                                        <div class="tile-object">
                                            <div class="name">Chambre</div>
                        ...
                        <!--<div class="tiles">-->
                                ...
                                foreach($devices as $device){
                                    ...
                                    echo '<div class="tiles" style="display:table-row;float:left;">';
