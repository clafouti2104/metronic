...
?>
<div class="col-lg-<?php echo $chart->size; ?> col-md-6 col-sm-6 col-xs-12 boxPackery itempage itempage-<?php echo $item->id; ?>" iditempage="<?php echo $item->id; ?>" style="height:400px;">
