...
foreach($devices as $device){
    ...
    foreach($messages as $messageTmp){
        ...
        echo "<td><input type=\"text\" class=\"form-control\" value=\"http://".$_SERVER['SERVER_ADDR']."/metronic/api/execute_message.php?idMessage=".$messageTmp->id."\" /></td>";
        echo "</tr>";
    }
}
?>
...
foreach($scenarios as $scenario){
    ...
    echo "<td><input type=\"text\" class=\"form-control\" value=\"http://".$_SERVER['SERVER_ADDR']."/metronic/api/execute_scenario.php?idScenario=".$scenario->id."\" /></td>";
    echo "</tr>";
}
?>
                </tbody>
